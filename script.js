...
function applyLemonVisibility() {
    if (sessionStorage.getItem("lemon-hide") || localStorage.getItem("lemon-hide")) {
        [].forEach.call(document.getElementsByClassName("lemon-message"), elt => elt.style.display = 'none');
    }
}

function lemonHidePermanently() {
    localStorage.setItem("lemon-hide", "yes");
    applyLemonVisibility();
}

function lemonHideTemporarily() {
    sessionStorage.setItem("lemon-hide", "yes");
    applyLemonVisibility();
}
